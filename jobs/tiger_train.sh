...
python -m src.train experiment=tiger_train_flat \
    ...
    semantic_id_path=$BASE/results/sid_rkmeans/${MODEL_SIZE}/${DATASET}/rkmeans_inference/pickle/merged_predictions_tensor.pt \
    num_hierarchies=4 \
    hydra.run.dir=$BASE/results/tiger/${MODEL_SIZE}/${DATASET}_rkmeans